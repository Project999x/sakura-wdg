...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7516838777:AAHbCjFU9UfkfBMzCqiYmp6e-pmRlBjuLU8")
#Your API ID from my.telegram.org
APP_ID = int(os.environ.get("APP_ID", "24850641"))
#Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "277f50bb9a96f9bfd54b467fc5723dc0")
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1001985214229"))
# NAMA OWNER
OWNER = os.environ.get("OWNER", "Aizen_Sausake_Sama")
#OWNER ID
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002465142238"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002265864308"))
